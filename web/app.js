...
wrapper.innerHTML = `<div class="pin-inner"> <svg viewBox="0 0 56 72" fill="none" xmlns="http://www.w3.org/2000/svg"> <defs> <filter id="${id}" x="-40%" y="-20%" width="180%" height="180%"> <feDropShadow dx="0" dy="2" stdDeviation="2" flood-color="${shadow}" flood-opacity="0.3"/> </filter> </defs> <path d="M28 4C16.954 4 8 12.954 8 24C8 38 28 68 28 68C28 68 48 38 48 24C48 12.954 39.046 4 28 4Z" fill="${color}" filter="url(#${id})"/> </svg> <div class="pin-emoji">${emoji}</div> </div> <div class="pin-shadow"></div>`;
return wrapper;
}
